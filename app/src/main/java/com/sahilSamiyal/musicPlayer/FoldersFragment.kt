...
import com.sahilSamiyal.musicPlayer.databinding.FragmentFoldersBinding
...
class FoldersFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.FoldersRV.adapter = FolderAdapter(requireContext(),VideoActivity2.folderList)
        binding.totalFolders.text="Total Folders: ${VideoActivity2.folderList.size}"
        return view
    }
}