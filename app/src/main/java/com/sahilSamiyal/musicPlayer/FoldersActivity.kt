...
import com.sahilSamiyal.musicPlayer.databinding.ActivityFoldersBinding
import java.io.File
...
class FoldersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = VideoActivity2.folderList[position].folderName
        currentFolderVideo =getAllVideos(VideoActivity2.folderList[position].id)
